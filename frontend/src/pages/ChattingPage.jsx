...
const ChattingPage = () => {
  ...
  return (
    <div className=' min-w-sm bg-white p-6 md:p-8 flex justify-center items-center'>
      <div className='h-screen flex flex-col gap-8 '>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='max-h-96 no-scrollbar overflow-y-auto scroll-smooth min-w-0 flex-1 flex flex-col gap-4' >
